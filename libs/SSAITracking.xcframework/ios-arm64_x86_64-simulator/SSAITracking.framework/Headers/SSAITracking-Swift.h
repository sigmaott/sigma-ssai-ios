...
@interface SigmaSSAI : NSObject <AVAssetResourceLoaderDelegate, AVPlayerItemLegibleOutputPushDelegate, AVPlayerItemMetadataOutputPushDelegate, PALNonceLoaderDelegate>
- (void)nonceLoader:(PALNonceLoader * _Nonnull)nonceLoader withRequest:(PALNonceRequest * _Nonnull)request didLoadNonceManager:(PALNonceManager * _Nonnull)nonceManager;
